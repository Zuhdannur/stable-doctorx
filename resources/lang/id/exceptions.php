...
return [
    ...
    */
    ...
    'cannot_view' => 'Anda tidak diizinkan menampilkan data ini.',
    'cannot_create' => 'Anda tidak diizinkan menambahkan data ini.',
    'cannot_edit' => 'Anda tidak diizinkan mengedit data ini.',
    'cannot_delete' => 'Anda tidak diizinkan menghapus data ini.',
    ...
    'backend' => [
        'access' => [
            ...
            'abilities' => [
                'already_exists'    => 'Peran tersebut sudah ada. Pilihlah nama yang berbeda.',
                'cant_delete_admin' => 'Anda tidak dapat menhapus Izin Administrator.',
                'create_error'      => 'Ada masalah saat membuat izin ini. Silakan coba lagi.',
                'delete_error'      => 'Ada masalah saat menghapus izin ini. Silakan coba lagi.',
                'has_users'         => 'Anda tidak dapat menghapus izin dengan pengguna yang berkaitan.',
                'needs_permission'  => 'Anda harus memilih setidaknya satu izin untuk izin ini.',
                'not_found'         => 'Peran tersebut tidak ada.',
                'update_error'      => 'Ada masalah saat memperbarui izin ini. Silakan coba lagi.',
            ],
