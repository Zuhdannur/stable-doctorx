...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('labels.backend.access.roles.management') <small class="text-muted">@lang('labels.backend.access.roles.create')</small></h3>
                                    ...
                                    <div class="col-md-4 col-xl-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="custom-control custom-checkbox mb-5">
                                                {{ html()->checkbox('abilities[]', old('abilities') && in_array($items->name, old('abilities')) ? true : false, $items->name)->class('custom-control-input')->id('ability-'.$items->id) }}
