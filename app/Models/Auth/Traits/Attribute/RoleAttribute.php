...
trait RoleAttribute
{
    ...
    {
        return '<a href="'.route('admin.auth.role.edit', $this).'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"><i class="fa fa-edit"></i></a> &nbsp;';
    }
