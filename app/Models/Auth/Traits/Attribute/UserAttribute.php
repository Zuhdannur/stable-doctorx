...
trait UserAttribute
{
    ...
    {
        $abilities = $this->getAbilities()->toArray();
    ...
    {
        return '<a href="'.route('admin.auth.user.show', $this).'" title="'.__('buttons.general.crud.view').'" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a> &nbsp;';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.edit', $this).'" class="btn btn-sm btn-primary" title="'.__('buttons.general.crud.edit').'"><i class="fa fa-edit"></i></a> &nbsp;';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.restore', $this).'" name="confirm_item" class="btn btn-sm btn-info"><i class="fa fa-share-square" data-toggle="tooltip" data-placement="top" title="'.__('buttons.backend.access.users.restore_user').'"></i></a> ';
    }
    ...
    public function getActionButtonsAttribute()
    {
    	...
    	<div class="btn-group" role="group" aria-label="'.__('labels.backend.access.users.user_actions').'">
		  ...
		  <div class="btn-group btn-group-sm" role="group">
			<button id="userActions" type="button" class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
