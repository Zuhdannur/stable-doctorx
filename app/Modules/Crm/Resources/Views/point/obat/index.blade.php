...
<div class="block" id="my-block">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('crm::labels.point.obat.main')</h3>
    </div>
        ...
        <table id="table" class="table table-sm table-hover table-striped table-vcenter js-dataTable-full-pagination" width="100%">
            <thead class="thead-light">
                <tr>
                    ...
                    <th>@lang('crm::labels.point.obat.table.product_code')</th>
                    <th>@lang('crm::labels.point.obat.table.name')</th>
                    <th>@lang('crm::labels.point.obat.table.point')</th>
                    <th>@lang('crm::labels.point.obat.table.min_qty')</th>
...
<script>
    jQuery(function(){
        var dt = $('#table').DataTable({
            ...
            ordering: true,
            pageLength: 25,
            ajax: '{!! route('admin.crm.point.obat.index') !!}',
            language: {
