...
@section('title', app_name() . ' | '. __('room::labels.group.management'))

@section('content')
<div class="block" id="my-block">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('room::labels.group.management')</h3>
        <div class="block-options">
            <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                <a href="{{ route('admin.room.group.create') }}" class="btn btn-sm btn-alt-info" data-toggle="tooltip" title="@lang('labels.general.create_new')">
    ...
    <div class="block-content block-content-full">
        <table id="table" class="table table-sm table-hover table-striped table-vcenter js-dataTable-full-pagination" width="100%">
            <thead class="thead-light">
                <tr>
                    <th>#</th>
                    <th>@lang('room::labels.group.table.name')</th>
                    <th>@lang('room::labels.group.table.floor')</th>
                    <th>@lang('room::labels.group.table.description')</th>
...
<script>
    $(function () {
        var dt = $('#table').DataTable({
            ...
            order: [[ 1, "asc" ]],
            pageLength: 10,
            ajax: '{!! route('admin.room.group.index') !!}',
            language: {
