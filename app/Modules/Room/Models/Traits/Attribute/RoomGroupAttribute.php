...
trait RoomGroupAttribute
{
    ...
    {
        return '<a href="'.route('admin.room.group.edit', $this).'" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'"><i class="fa fa-edit"></i></a> &nbsp;';
    }
    ...
    {
        return '<a href="'.route('admin.room.group.destroy', $this).'"
			 data-method="delete"
