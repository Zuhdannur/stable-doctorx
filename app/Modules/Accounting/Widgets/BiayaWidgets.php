...
class BiayaWidgets extends AbstractWidget
{
    /**
    ...
    */
    ...
    public function unpaid()
    {
        ...
        $unpaid = FinanceBiayaTrx::where('status', '0') //0 unpaid
        ->sum('remain_payment');
    ...
    {
        return FinanceBiayaTrx::with('financeTrx')
    ...
    public function run()
    {
        ...
        return view('accounting::widgets.biaya', compact('unpaid','paid_last_30_days','due_date'));
    }
}