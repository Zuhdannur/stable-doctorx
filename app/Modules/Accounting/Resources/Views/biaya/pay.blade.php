...
@section('content')
        ...
        <div class="block-content block-content-full">
            <div class="row px-5 pt-5">
                <div class="col-4 contact-details">
                    <h5>Penerima: {{ $biaya->financeTrx->person }}</h5>
                    <h6>{{ $biaya->financeTrx->transaction_code }}</h6>
                </div>
            ...
            <div class="table-responsive push">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            @if ($biaya->potongan)
                                <td colspan="4" class="font-w600 text-right">Potongan ( {{ $biaya->potongan->account->account_name}}) : {{ $biaya->potongan->potongan_value.' %' }}</td>
            ...
            <div class="row-mt-4">
                {{-- form --}}
                <form method="post" class="js-validation-bootstrap" id="biaya_pay" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row-mt-4">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control tanpa-rupiah text-right" id="total_pay" name="total_pay" value="{{ $biaya->remain_payment}}">
                            </div>
                            <div class="col-md-4">
    ...
    <script>
        var remain_payment = "{{ $biaya->remain_payment }}";
        jQuery(function(){
            ...
            $(document).ready(function(){
             ...
             var validator = jQuery('.js-validation-bootstrap').validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('admin.accounting.biaya.savePay') }}",
                        data: data,
                        processData: false,
                        contentType: false,
                        dataType: 'json',
