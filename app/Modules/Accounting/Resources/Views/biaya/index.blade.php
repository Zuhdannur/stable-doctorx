...
@section('content')
    @widget('App\Modules\Accounting\Widgets\BiayaWidgets')
            ...
            <table id="table" class="table table-sm table-hover table-striped table-vcenter js-dataTable-full-pagination" width="100%">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th>@lang('accounting::labels.biaya.table.code')</th>
                        <th>@lang('accounting::labels.biaya.table.receiver')</th>
                        <th>@lang('accounting::labels.biaya.table.status')</th>
                        <th>@lang('accounting::labels.biaya.table.due_date')</th>
                        <th>@lang('accounting::labels.biaya.table.bill')</th>
                        <th>@lang('accounting::labels.biaya.table.total')</th>
    ...
    <script>
         jQuery(function(){
            var dt = $('#table').DataTable({
                ...
                pageLength: 25,
                ajax: {
                        url : '{!! route('admin.accounting.biaya') !!}',
                        data : function(data){
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        name: 'finance_trx.transaction_code',
                    },
                    {
                        data: 'finance_trx.person',
                        name: 'finance_trx.person',
                    },
                    {
                        data: 'status',
                        name: 'status',
