        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <small class="text-muted">
                    &nbsp;
                    @lang('accounting::labels.account.edit')
                </small>
            </h3>
        </div>
                ...
                <div class="row-mt-4">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="acc_name" id="acc_name" class="form-control" value="{{ $account->account_name}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="acc_desc" class="col-md-2 form-control-label">Deskripsi</label>
                            <div class="col-md-6">
                                <textarea name="acc_desc" id="acc_desc" cols="30" rows="5" class='form-control' value="{{ $account->decription}}"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
