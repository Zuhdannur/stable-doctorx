...
@section('title', app_name(). ' | '. _('accounting::cash.create'))
    ...
    <div class="block" id="my-block2">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <small class="text-muted">
                    &nbsp;
                    @lang('accounting::labels.cash.create')
                </small>
            </h3>
        </div>
        ...
        <div class="block-content">
            <form method="post" class="js-validation-bootstrap" id="formGeneral" autocomplete="off">
                ...
                <div class="form-group row">
                    <div class="col-md-1">
                        {{ form_cancel(route('admin.accounting.cash'), __('buttons.general.cancel')) }}
                    </div>
                ...
                var initValidationBootstrap = function(){
                    jQuery('.js-validation-bootstrap').validate({
                        ...
                        submitHandler: function(form){
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('admin.accounting.cash.store') }}",
                                data: $(form).serialize(),
