...
@section('title', app_name() . ' | '. __('accounting::menus.kas.title'))

@section('content')
<div class="block" id="my-block">
    <div class="block-header block-header-default">
        <h3 class="block-title">@lang('accounting::labels.cash.cash')</h3>
        <div class="block-options">
            <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                <a href="{{ route('admin.accounting.cash.create') }}" class="btn btn-sm btn-alt-info" data-toggle="tooltip" title="@lang('labels.general.create_new')">
    ...
    <div class="block-content block-content-full">
        <table id="table" class="table table-sm table-hover table-striped table-vcenter js-dataTable-full-pagination" width="100%">
            <thead class="thead-light">
                <tr>
                    <th>#</th>
                    <th>@lang('accounting::labels.cash.table.acc_code')</th>
                    <th>@lang('accounting::labels.cash.table.name')</th>
                    <th>@lang('accounting::labels.cash.table.balance')</th>
...
<script>
    jQuery(function(){
        var dt = $('#table').DataTable({
            ...
            ordering: false,
            pageLength: 10,
            ajax: '{!! route('admin.accounting.cash') !!}',
            language: {
