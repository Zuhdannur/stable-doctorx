        ...
        <table width="100%">
            <tr>
                <td align="left" style="width: 40%;">
                    <h3>Penerima : {{ $trx->person }}</h3>
                    <p>Kirim Dari : {{ isset($cash->account) ? $cash->account->account_code .' - '. $cash->account->account_name : ''}}</p>
                    <p>Tanggal Transaksi : {{ isset($trx) ? date('d/m/Y',strtotime($trx->trx_date)) : '' }}</p>
        ...
        <table class="table table-hover" width="100%">
            <thead class="thead splitForPrint">
                <tr>
                    ...
                    <th scope="col gray-ish">Pembayaran Untuk</th>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="5" class="font-w600 text-right">Potongan ( {{ isset($potongan->account) ? $potongan->account->account_name : '' }}) : {{ ' %' }}</td>
