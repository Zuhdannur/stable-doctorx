            ...
            <div class="block-options">
                ...
                <div class="btn-group" role="group" aria-label="Third group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="toolbarDrop" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 34px, 0px);">
                        ...
                        <a class="dropdown-item" href="{{ route('admin.accounting.cash.journal.receipt.pdf', $trx->id) }}" target="_blank">
        ...
        <div class="block-content">
            ...
            <div class="row px-5 pt-5">
                <div class="col-3 contact-details">
                    <h3 class="block-title">Pembayar : {{ $trx->person }}</h3>
                    <h3 class="block-title">Setor Ke : {{ isset($cash->account) ? $cash->account->account_code .' - '. $cash->account->account_name : ''}}</h3>
                </div>
            ...
            <div class="table-responsive push mt-4">
                <table class="table table-bordered table-hover">
                    ...
                    @if (isset($acc_receipt))
                        @foreach ($acc_receipt as $item)
                            <tr>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            $(document).on('click', '.printInv', function() {
                $.ajax({
                    url: "{{ route('admin.accounting.cash.journal.receipt.print', $trx->id) }}",
                    type: 'GET',
