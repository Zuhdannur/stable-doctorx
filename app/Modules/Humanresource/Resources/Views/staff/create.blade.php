...
@section('content')
<form class="js-validation-bootstrap form-vertical" method="post" action="{{ route('admin.humanresource.staff.store') }}" id="formGroup" enctype="multipart/form-data" autocomplete="off">
    @method('POST')
     @csrf
    <div class="block" id="my-block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Data Staff</h3>
        </div>
        <div class="block-content">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" id="role_id" name="role_id">
                                ...
                                @foreach ($roles as $item)
                                    <option value="{{ $item->name }}" {{ ( $item->name == old('role_id')) ? 'selected' : '' }}> {{ $item->title }} </option>
                                @endforeach    
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" id="designation_id" name="designation_id">
                                ...
                                @foreach ($designations as $item)
                                    <option value="{{ $item->id }}" {{ ( $item->id == old('designation_id')) ? 'selected' : '' }}> {{ $item->name }} </option>
                                @endforeach    
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <select class="form-control" id="department_id" name="department_id">
                                ...
                                @foreach ($departments as $item)
                                    <option value="{{ $item->id }}" {{ ( $item->id == old('department_id')) ? 'selected' : '' }}> {{ $item->department_name }} </option>
                                @endforeach    
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control datepicker" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}">
                                    </div>
                                </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" name="blood_id" id="blood_id" class="form-control">
                                ...
                                @foreach ($bloodbank as $item)
                                    <option value="{{ $item->id }}" {{ ( $item->id == old('blood_id')) ? 'selected' : '' }}> {{ $item->blood_name }} </option>
                                @endforeach  
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" id="marital_status" name="marital_status">
                                ...
                                @foreach ($maritalstatus as $item)
                                    <option value="{{ $item->id }}" {{ ( $item->id == old('marital_status')) ? 'selected' : '' }}> {{ $item->name }} </option>
                                @endforeach  
                            </select>
                        </div>
                        <div class="col-6">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control datepicker" id="date_of_joining" name="date_of_joining" value="{{ old('date_of_joining') }}">
                        </div>
                        <div class="col-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <div class="col-6">
                            <label for="mega-username">Username</label>
