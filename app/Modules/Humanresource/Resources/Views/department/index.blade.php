...
@section('title', app_name() . ' | Departemen')

@section('content')
<div class="block" id="my-block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Data Departemen</h3>
        <div class="block-options">
            <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                <a href="{{ route('admin.humanresource.department.create') }}" class="btn btn-sm btn-alt-info" data-toggle="tooltip" title="@lang('labels.general.create_new')">
...
<script>
    $(function () {
        var dt = $('#table').DataTable({
            ...
            ordering: false,
            pageLength: 10,
            ajax: '{!! route('admin.humanresource.department.index') !!}',
            language: {
