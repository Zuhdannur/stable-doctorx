...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Departemen <small class="text-muted">Tambah Data</small></h3>
        
    </div>
    <div class="block-content">
        {{ html()->form('POST', route('admin.humanresource.department.store'))->class('form-horizontal js-validation-bootstrap')->open() }}
            <div class="row mt-4">
                <div class="col">
