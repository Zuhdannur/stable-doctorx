...
@section('title', 'Edit Insentif')

@section('content')
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Insentif <small class="text-muted">Edit Data</small></h3>
        
    </div>
    <div class="block-content">
        {{ html()->modelForm($incentive, 'PATCH', route('admin.incentive.update', $incentive))->class('form-horizontal js-validation-bootstrap')->open() }}
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" class="form-control" id="product_incentive" name="product_incentive" value="{{ $incentive->product_incentive ?? old('product_incentive') ?? 0 }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="number" class="form-control" id="point_value" name="point_value" value="{{ $incentive->point_value ?? old('point_value') ?? 0 }}">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        point
                                    </span>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-hover table-striped table-vcenter" id="tab_logic3">
                        <thead>
                            <tr>
                                <th class="text-center" style="width: 50px;"><button type="button" class="btn btn-sm btn-circle btn-outline-success add3" title="Tambah Item">
                                        <i class="fa fa-plus"></i>
                                    </button></th>
                                <th style="width: 50px;"> # </th>
                                <th> Tindakan </th>
