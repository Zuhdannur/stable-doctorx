...
@section('title', app_name() . ' | Insentif Staff')
...
<div class="block" id="my-block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Komisi Staff</h3>
        <div class="block-options">
            <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                <a href="{{ route('admin.incentive.staff.create') }}" class="btn btn-sm btn-alt-info" data-toggle="tooltip" title="@lang('labels.general.create_new')">
...
<script>
    $(function () {
        ...
        var table = $('#table').DataTable({
            ...
            order: [[ 1, 'asc' ]],
            pageLength: 10,
            ajax: '{!! route('admin.incentive.staff.index') !!}',
            language: {
