...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Paket Service <small class="text-muted">@lang('product::menus.services-packages.edit')</small></h3>
    </div>
    <div class="block-content">
        {{ html()->form('PATCH', route('admin.product.services-packages.store'))->class('js-validation-bootstrap form-horizontal')->attributes(['autocomplete' => 'off'])->open() }}
            <div class="row mt-4">
                <input type="hidden" name="service_packages_id" value="{{ $servicesPackage->id }}">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->text('description')
                                ->class('form-control')
                                ->value($servicesPackage->description)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="checkbox" id="is_active" name="is_active" class="switch-input" {{ $servicesPackage->is_active == 1 ? 'checked' : '' }}>
...
<script type="text/javascript">
    jQuery(function () {
        ...
        $(document).on('click', '.add', function() {
            var htmlDropdown = '<select class="form-control service required" id="' + (i + 1) + 'select2" name="service[' + (i + 1) + ']" data-placeholder="Pilih" style="width: 100%">{!! $service !!}</select>';
            var html = '';
            html += '<tr>';
