...
@section('title', 'Tambah Paket Produk')

@section('content')
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Paket Obat <small class="text-muted">@lang('product::labels.product.create')</small></h3>
        
    </div>
    <div class="block-content">
        {{ html()->form('POST', route('admin.product.productpackage.store'))->class('js-validation-bootstrap form-horizontal')->attributes(['autocomplete' => 'off'])->open() }}
            <div class="row mt-4">
                <div class="col">
                    ...
                    <table class="table table-bordered table-hover table-striped table-vcenter" id="tab_logic">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control product required" id="1select2" name="category_id[1]" data-placeholder="Pilih" style="width: 100%">
                                        {!! $product !!}
                                    </select>
                                </td>
                                <td>
