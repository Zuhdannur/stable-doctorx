...
@section('title', app_name().' | '.__('product::menus.supplier.edit'))
...
@section('content')
    <div class="block" id="my-block2">
        ...
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('product::labels.supplier.management') <small class="text-muted">@lang('product::labels.supplier.edit')</small></h3>
        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                {!! Form::select('gender', ['M'=>'Laki - Laki','F'=>'Perempuan'], $supplier->gender, ['class' => 'form-control', 'placeholder' => 'Pilih Jenis Kelamin', 'required' => 'true','id' => 'gender']) !!}
                            </div>
                            <div class="col-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="birth_place" name="birth_place" value="{{ $supplier->birth_place }}">
                            </div>
                            <div class="col-4">
                                <label>Tanggal Lahir</label>
                                <input type="text" class="js-masked-date form-control" id="dob" name="dob" placeholder="dd/mm/yyyy" value="{{ $supplier->dobFormatted }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="company_phone_number" name="company_phone_number" value="{{ $supplier->company_phone_number }}">
                            </div>
                            <div class="col-4">
                                <label>Kota</label>
                                <br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" id="company_address" name="company_address" value="{{ $supplier->company_address }}">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        jQuery(function(){
                ...
                var initValidationBootstrap = function(){
                    jQuery('.js-validation-bootstrap').validate({
                        ...
                        submitHandler: function(form) {
                            $.ajax({
                                type: "POST",
                                url: "{{ route('admin.product.supplier.update') }}",
                                data: $(form).serialize(),
                                dataType: 'json',
            ...
            $('#company_city_id').select2({
                initSelection: function(element, callback) {
                    $.ajax({
                        url: "{{ url('citiesProv', ['company_city_id' => $supplier->company_city_id ])}}",
                        method:'GET',
                        dataType: 'json',
                        success : function (data){
                            callback({id: data.id,text: data.text +', '+ data.value});
                            $('#company_city_id').append('<option value="'+data.id+'" selected="selected">'+data.text +', '+ data.value+'</option>');
                            $('#company_city_id').val(data.id).trigger('change');
                            populateDistrict(data.id, '#company_district_id');               
                        }
                    });
                },
                ajax: {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.length > 0) {
                            ...
                            $("select" + elemen).val("{{ $supplier->company_district_id }}").trigger('change');
                        } else {
                            alert('data empty!');
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.length > 0) {
                            ...
                            $("select" + elemen).val("{{ $supplier->company_village_id }}").trigger('change');
