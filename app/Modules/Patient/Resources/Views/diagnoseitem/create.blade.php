...
@section('title', __('patient::labels.diagnoseitem.management') . ' | ' . __('patient::labels.diagnoseitem.create'))
...
<div class="block">
    ...
    <div class="block-content">
        {{ html()->form('POST', route('admin.masterdata.diagnoseitem.store'))->class('form-horizontal')->open() }}
            <div class="row mt-4">
                <div class="col">
