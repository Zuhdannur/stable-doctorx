                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover table-striped table-vcenter table-bordered mb-0">
                            ...
                            <tbody>
                                    ...
                                    <tr class="table-{{ isset($data->patient->flag->color_code) ? $data->patient->flag->color_code : "info" }}">
                                        <td>
                                        ...
                                        <td>
                                            <strong>{{ $data->is_online == 1 ? "Y" : "N" }}</strong>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <p class="font-size-sm text-muted mb-0"><a class="font-w600 btn btn-sm btn-success mb-5 mb-5" href="{{ route('admin.patient.prescription.create', $data->appointment_no) }}">Check Data</a></p>
                                        </td>
                                    </tr>
                                    @endforeach
                            </tbody>
                        ...
                        <table class="table table-hover table-striped table-vcenter mb-0">
                            ...
                            <tbody>
                                    ...
                                    <tr class="table-{{ isset($data->patient->flag->color_code) ? $data->patient->flag->color_code : "info" }}">
                                        ...
                                        <td class="text-right">
                                            <p class="font-size-sm text-muted mb-0"><a class="font-w600 btn btn-sm btn-success mb-5 mb-5" href="{{ route('admin.patient.treatment.show', $data->id) }}">Check Data</a></p>
                                        </td>
                                    </tr>
                                    @endforeach
                            </tbody>
