...
@section('title', app_name() . ' | '. __('booking::menus.calendar.jadwal-appointment'))
...
@section('content')
    ...
    <div class="block" id="my-block-2">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('booking::menus.calendar.jadwal-appointment')</h3>
        </div>
    ...
    <script>
         jQuery(function(){
            var dt = $('#table').DataTable({
                ...
                pageLength: 25,
                ajax: {
                        url : '{!! route('admin.calendar.jadwal-appointment') !!}',
                        data : function(data){
